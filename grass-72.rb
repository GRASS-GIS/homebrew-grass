class Grass72 < Formula
  ...
  head do
    url "https://svn.osgeo.org/grass/grass/branches/releasebranch_7_2"
    patch :DATA
  end
  ...
  def install
    ...
    ## ln_sf "../bin/grass72", prefix/"grass-#{version.to_s}/grass72.sh"
